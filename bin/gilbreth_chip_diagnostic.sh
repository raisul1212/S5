...
#SBATCH --mem=32G
#SBATCH --time=0:30:00
#SBATCH --output=results/slurm/chip_diagnostic_%j.out
#SBATCH --error=results/slurm/chip_diagnostic_%j.err
...
python -u bin/chip_eval_diagnostic.py \
