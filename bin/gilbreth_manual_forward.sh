...
#SBATCH --mem=32G
#SBATCH --time=0:30:00
#SBATCH --output=results/slurm/manual_forward_%j.out
#SBATCH --error=results/slurm/manual_forward_%j.err
...
python -u bin/manual_forward.py \
