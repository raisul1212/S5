...
#SBATCH --mem=32G
#SBATCH --time=0:30:00
#SBATCH --output=results/slurm/flax_test_%j.out
#SBATCH --error=results/slurm/flax_test_%j.err
...
python -u bin/test_flax_serialization.py \
