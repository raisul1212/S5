...
#SBATCH --output=results/slurm/chip_mamb_iso_%j.out
#SBATCH --error=results/slurm/chip_mamb_iso_%j.err
...
CKPT_DIR="./checkpoints/chip_mamb_iso_${JOB}"
mkdir -p "$CKPT_DIR"

echo "Corner 3' + chip eval (JOB=$JOB, SHA=$SHA)"
