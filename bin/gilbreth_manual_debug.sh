...
#SBATCH --mem=32G
#SBATCH --time=0:20:00
#SBATCH --output=results/slurm/manual_debug_%j.out
#SBATCH --error=results/slurm/manual_debug_%j.err
...
python -u bin/manual_forward_debug.py \
